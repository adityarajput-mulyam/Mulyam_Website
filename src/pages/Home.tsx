...
export default function Home() {
  return (
    <div className="bg-mulyam-blue min-h-screen font-sans antialiased text-white selection:bg-mulyam-green selection:text-mulyam-blue">
      {/* Block 1: Hero Entry & Associated Brands Anchor */}
      <HeroBlock />

      {/* Block 2: The Core "What is Mulyam?" Strategic Narrative Layer */}
      <section id="about" className="py-20 md:py-28 px-8 md:px-12 bg-slate-950/20 w-full border-t border-b border-white/5">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-center">
            ...
            <div className="md:col-span-8 space-y-6">
              <p className="font-sans font-light text-slate-300 text-lg md:text-xl leading-relaxed">
              ...
              <p className="font-sans font-light text-slate-400 text-base md:text-lg leading-relaxed">
                By leveraging real-time logistics tracking, automated AI computer vision sorting, and direct farmer support platforms like <strong className="text-white">ImKisan</strong>, we bring value, stability, and absolute traceability to the agricultural commerce network.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-slate-950/60 border-t border-white/10 py-12 px-8 md:px-12 w-full">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div>
            ...
            <p className="text-xs text-slate-450 max-w-sm font-light leading-relaxed text-slate-400">
